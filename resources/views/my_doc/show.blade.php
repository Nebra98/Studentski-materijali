                ...
                @forelse($files as $file)
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a class="float-right" href="{{ route('my_documents.edit',$file->id) }}"> <button type="button" class="btn btn-warning float-left"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                    ...
                    @empty
                        <div class="alert alert-warning">
                            <strong style="font-size:2rem;width:100%;text-align:center;">&#128543;</strong><strong>Oops!</strong> Nemate ni jedan vlastiti dokument
                        </div>
                @endforelse
                {{ $files->links() }}
            </div>
